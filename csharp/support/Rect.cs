...
namespace muscle.support {  
    public class Rect : Flattenable {
        ...
        ///<summary>Constructor where you specify the left, top, right, and bottom coordinates</summary>
        ///<param name="b"></param>
        ///<param name="l"></param>
        ///<param name="r"></param>
        ///<param name="t"></param>
        ...
        ///<summary>Sets this equal to (rhs).</summary>
        ///<param name="rhs">The rectangle to become like.</param>
        ///<exception cref="ClassCastException">if (rhs) isn't a Rect</exception>
        ...
        ///<summary>Set a new position for the rectangle.</summary>
        ///<param name="b"></param>
        ///<param name="l"></param>
        ///<param name="r"></param>
        ///<param name="t"></param>
        ...
        ///<summary>Print the rectangle's current state to (out)</summary>
