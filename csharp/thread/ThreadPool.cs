...
public sealed class ThreadPool implements Runnable
{
   ...
   {      
      ...
      if ((_idleThreadCount <= 0)&&(_threadCount < _highMark))
      {
         ...
         System.Threading.Thread t = new System.Threading.Thread(_threadGroup, this, "MUSCLE worker thread-"+_threadCount);
         t.setDaemon(true);
...
public void run()
   ...
   private LinkedList _tasks = new LinkedList();  // Runnables that need to be run
